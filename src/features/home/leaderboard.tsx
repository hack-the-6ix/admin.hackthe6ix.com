...
export default function LeaderBoard() {
  const reviewers = [
    { name: 'Aurora Shi', total: 1200 },
    { name: 'Winston Yu', total: 1100 },
    { name: 'Martin He', total: 950 },
    { name: 'Emily Chen', total: 890 },
    { name: 'Daniel Zhang', total: 850 },
    { name: 'Emily Chen', total: 890 },
    { name: 'Daniel Zhang', total: 850 },
    { name: 'Emily Chen', total: 890 },
    { name: 'Daniel Zhang', total: 850 },
  ...
  return (
    <div className="p-6 m-4 bg-primary dark:bg-slate-700 text-center rounded-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 m-4">
        <div className="bg-primary-light dark:bg-slate-800 rounded-lg pr-5 pl-5">
        ...
        <div className="p-2 bg-primary-light dark:bg-slate-800 rounded-lg">
          ...
          <div className="m-4 space-y-4">
            {reviewers.slice(3).map((reviewer, index) => (
              <div
                key={index}
                className="flex justify-between items-center bg-slate-100 dark:bg-slate-900 p-4 rounded-lg"
              >
